...
@section('content')
  <div class="min-h-screen flex ">
              ...
              <div class="text-center mb-8">
                  ...
                  <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                      ...
                      <a href="{{ route('register') }}"
                          ...
                          onclick="navigateWithTheme('{{ route('register') }}')">
                          daftar akun baru
                      </a>
                  </p>
              </div>
                  ...
                  {{-- <div class="mt-6">
                      <div class="relative">
                          ...
                          <div class="relative flex justify-center text-sm">
                              <span class="px-2 bg-gray-50 dark:bg-gray-900 text-gray-500 dark:text-gray-400">Atau masuk
                                  dengan</span>
                          </div>
                      </div>
      ...
      <div class="hidden lg:block relative w-0 flex-1">
          <div
              class="absolute inset-0 h-full w-full bg-gradient-to-br from-gray-800 to-gray-900 dark:from-gray-900 dark:to-black">
              <div class="flex flex-col justify-center items-center h-full text-white p-12">
                  <div class="text-center">
                      ...
                      <h1 class="text-4xl font-bold mb-4">Kantin Reseller</h1>
                      <p class="text-xl text-gray-300 mb-8">Platform manajemen reseller terpercaya</p>
